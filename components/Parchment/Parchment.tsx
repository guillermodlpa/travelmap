...
const ParchmentItself = styled(Box)`
...
const Parchment: React.FC<{ contentPad: PadType }> = ({ children, contentPad }) => (
  <ParchmentItself background="parchment" pad={contentPad} width="large" overflow="auto">
    {children}
  </ParchmentItself>
);
...
//   useEffect(() => {
//     setBackgroundHeight(content?.current?.offsetHeight);
//   }, [content]);

//   return (
//     <>
//       <ParchmentContainer pad={contentPad} width="large" >
//         <ParchmentContent ref={content}>{children}</ParchmentContent>
